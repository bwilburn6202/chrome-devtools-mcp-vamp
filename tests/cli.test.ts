...
describe('cli args parsing', () => {
  const defaultArgs = {
    ...
    categoryExport: true,
    'experimental-debugger': false,
    experimentalDebugger: false,
    'experimental-axe': false,
    experimentalAxe: false,
    'experimental-issues': false,
    experimentalIssues: false,
    'experimental-recorder': false,
    experimentalRecorder: false,
    'experimental-local-overrides': false,
    experimentalLocalOverrides: false,
    'experimental-cdp-passthrough': false,
    experimentalCdpPassthrough: false,
    'experimental-cdp-dangerous': false,
    experimentalCdpDangerous: false,
    ...
    // Phase 1 tunables (defaults).
    'tool-mutex-timeout-ms': 0,
    toolMutexTimeoutMs: 0,
    'drag-delay-ms': 50,
    dragDelayMs: 50,
    'file-chooser-timeout-ms': 3000,
    fileChooserTimeoutMs: 3000,
    'fill-char-multiplier-ms': 10,
    fillCharMultiplierMs: 10,
    'lighthouse-max-wait-ms': 30000,
    lighthouseMaxWaitMs: 30000,
    'slim-navigate-timeout-ms': 30000,
    slimNavigateTimeoutMs: 30000,
    'performance-auto-stop-ms': 5000,
    performanceAutoStopMs: 5000,
    'stack-trace-timeout-ms': 1000,
    stackTraceTimeoutMs: 1000,
    'screenshot-inline-limit-bytes': 2 * 1024 * 1024,
    screenshotInlineLimitBytes: 2 * 1024 * 1024,
    'console-stack-max-frames': 50,
    consoleStackMaxFrames: 50,
    'snapshot-max-nodes': 5000,
    snapshotMaxNodes: 5000,
    'trace-history-limit': 5,
    traceHistoryLimit: 5,
    'heap-snapshot-cache-size': 5,
    heapSnapshotCacheSize: 5,
  };
